...
public class OriginItemGroup {
    public static final ItemGroup AAOrigin = Registry.register(Registries.ITEM_GROUP, new Identifier(OriginsUnedibles.MOD_ID,"aaorigin"),
            FabricItemGroup.builder().displayName(Text.literal("Origin Edible Unedibles")).icon(() -> new ItemStack(Items.WHEAT_SEEDS)).entries((displayContext, entries) -> {
                ...
                entries.add(OriginItems.EDIBLE_ACA_SAP);
                entries.add(OriginItems.EDIBLE_BIRCH_SAP);
                entries.add(OriginItems.EDIBLE_CHERR_SAP);
                entries.add(OriginItems.EDIBLE_ALLU);
                entries.add(OriginItems.EDIBLE_AZU);
                entries.add(OriginItems.EDIBLE_ORCH);
                entries.add(OriginItems.EDIBLE_BROWN_MUSH);
                entries.add(OriginItems.EDIBLE_COBWEB);
                entries.add(OriginItems.EDIBLE_CORNF);
                entries.add(OriginItems.EDIBLE_CRIM_FUNG);
                entries.add(OriginItems.EDIBLE_CRIM_ROOT);
                entries.add(OriginItems.EDIBLE_DAND);
                entries.add(OriginItems.EDIBLE_DARK_OAK_SAP);
                entries.add(OriginItems.EDIBLE_HANGING_ROOT);
                entries.add(OriginItems.EDIBLE_JUNGLE_SAP);
                entries.add(OriginItems.EDIBLE_LILY_VAL);
                entries.add(OriginItems.EDIBLE_MANGROVE_SAP);
                entries.add(OriginItems.EDIBLE_OAK_SAP);
                entries.add(OriginItems.EDIBLE_ORANGE_TU);
                entries.add(OriginItems.EDIBLE_OXEYE);
                entries.add(OriginItems.EDIBLE_PINK_TU);
                entries.add(OriginItems.EDIBLE_POPPY);
                entries.add(OriginItems.EDIBLE_RED_SHROOM);
                entries.add(OriginItems.EDIBLE_RED_TU);
                entries.add(OriginItems.EDIBLE_SPRUCE_SAP);
                entries.add(OriginItems.EDIBLE_SUNFL);
                entries.add(OriginItems.EDIBLE_TORCHFL);
                entries.add(OriginItems.EDIBLE_TWIST_VINE);
                entries.add(OriginItems.EDIBLE_WARP_FUNG);
                entries.add(OriginItems.EDIBLE_WARP_ROOT);
                entries.add(OriginItems.EDIBLE_WEEP_VINE);
                entries.add(OriginItems.EDIBLE_WHITE_TU);
                entries.add(OriginItems.EDIBLE_WITHER);
            }).build());
