...
public class OriginItems {
    ...
    public static final Item EDIBLE_BLAZE_ROD = registerItem("edible_blaze_rod", new Item(new FabricItemSettings().food(FoodControl.BLAZEROD)));
    public static final Item EDIBLE_ENDER_EYE = registerItem("edible_ender_eye", new Item(new FabricItemSettings().food(FoodControl.ENDEREYE)));
    public static final Item EDIBLE_ENDER_PEARL = registerItem("edible_ender_pearl", new Item(new FabricItemSettings().food(FoodControl.ENDERPEARL)));
    public static final Item EDIBLE_FIRE_CHARGE = registerItem("edible_fire_charge", new Item(new FabricItemSettings().food(FoodControl.FIRECHARGE)));
    public static final Item EDIBLE_HEART_SEA = registerItem("edible_heart_of_the_sea", new Item(new FabricItemSettings().food(FoodControl.HEARTSEA)));
    public static final Item EDIBLE_NAUT_SHELL = registerItem("edible_nautilus_shell", new Item(new FabricItemSettings().food(FoodControl.NAUTSHELL)));
    public static final Item EDIBLE_NETH_STAR = registerItem("edible_nether_star", new Item(new FabricItemSettings().food(FoodControl.NETHSTAR)));
    public static final Item EDIBLE_POPPED_CHORUS = registerItem("edible_popped_chorus_fruit", new Item(new FabricItemSettings().food(FoodControl.POPPEDCHORUS)));
    public static final Item EDIBLE_SHULKER_SHELL = registerItem("edible_shulker_shell", new Item(new FabricItemSettings().food(FoodControl.SHULKSHELL)));
    public static final Item EDIBLE_BAMBOO = registerItem("edible_bamboo", new Item(new FabricItemSettings().food(FoodControl.BAMBOO)));
    public static final Item EDIBLE_BEETROOT_SEED = registerItem("edible_beetroot_seeds", new Item(new FabricItemSettings().food(FoodControl.BEETSEEDS)));
    public static final Item EDIBLE_BOOK = registerItem("edible_book", new Item(new FabricItemSettings().food(FoodControl.BOOK)));
    public static final Item EDIBLE_BRICK = registerItem("edible_brick", new Item(new FabricItemSettings().food(FoodControl.BRICK)));
    public static final Item EDIBLE_ECHO = registerItem("edible_echo_shard", new Item(new FabricItemSettings().food(FoodControl.ECHO)));
    public static final Item EDIBLE_GHAST_TEAR = registerItem("edible_ghast_tear", new Item(new FabricItemSettings().food(FoodControl.TEAR)));
    public static final Item EDIBLE_GLASS_BOTTLE = registerItem("edible_glass_bottle", new Item(new FabricItemSettings().food(FoodControl.BOTTLE)));
    public static final Item EDIBLE_GLOW_DUST = registerItem("edible_glowstone_dust", new Item(new FabricItemSettings().food(FoodControl.GDUST)));
    public static final Item EDIBLE_KELP = registerItem("edible_kelp", new Item(new FabricItemSettings().food(FoodControl.KELP)));
    public static final Item EDIBLE_MAGMA_CREAM = registerItem("edible_magma_cream", new Item(new FabricItemSettings().food(FoodControl.CREAM)));
    public static final Item EDIBLE_MELON_SEED = registerItem("edible_melon_seeds", new Item(new FabricItemSettings().food(FoodControl.MELONS)));
    public static final Item EDIBLE_NETHER_BRICK = registerItem("edible_nether_brick", new Item(new FabricItemSettings().food(FoodControl.NETHBRICK)));
    public static final Item EDIBLE_NETHER_WART = registerItem("edible_nether_wart", new Item(new FabricItemSettings().food(FoodControl.WART)));
    public static final Item EDIBLE_PAPER = registerItem("edible_paper", new Item(new FabricItemSettings().food(FoodControl.PAPER)));
    public static final Item EDIBLE_MEMBRANE = registerItem("edible_phantom_membrane", new Item(new FabricItemSettings().food(FoodControl.MEMBRANE)));
    public static final Item EDIBLE_PITHCHER = registerItem("edible_pitcher_pod", new Item(new FabricItemSettings().food(FoodControl.PITCH)));
    public static final Item EDIBLE_PUMP_SEEDS = registerItem("edible_pumpkin_seeds", new Item(new FabricItemSettings().food(FoodControl.PUMPS)));
